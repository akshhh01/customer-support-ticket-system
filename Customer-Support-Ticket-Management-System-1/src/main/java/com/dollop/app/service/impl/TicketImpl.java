...
public class TicketImpl implements ITicketDao{
	...
	public TicketDto createTicket(TicketDto dto) {
		...
		ticket.setCreatedBy(userRepository.findById(dto.getCreatedBy()).orElseThrow(()-> new ResourceNotFoundException("invalid user ")));
	...
	public List<TicketDto> getTicket(Integer id) {
		// TODO Auto-generated method stub
		Users user = userRepository.findById(id).orElseThrow(()-> new ResourceNotFoundException("use dont have this access"));
...
//	public List<Ticket> getTicketByCsr(Integer id){
//		
//	}
	
	
	@Override
	public TicketDto resolveTicket(Integer id) {
		// TODO Auto-generated method stub
		return null;
	}
